...
class ATMMLModel:
    def __init__(self):
        ...
        # Single-model policy: XGBoost only, to match ATMRiskClassifier below.
        # (Previously compared XGBoost/RandomForest/LinearRegression and
        # auto-selected the best by R^2 -- kept as a dict for minimal
        # downstream changes, but there's only one entry now.)
        self.models = {
